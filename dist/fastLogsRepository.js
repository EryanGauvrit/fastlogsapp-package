...
var FastLogsRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(this.API_URL, "/log").concat(queryParams && "?".concat(queryParams)), {
                                method: "GET",
                                headers: {
    ...
    FastLogsRepository.prototype.postFastLog = function (fastLog) {
        return __awaiter(this, void 0, void 0, function () {
            var personalData, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FastLogsRepository.prototype.deleteFastLog = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(this.API_URL, "/log/").concat(id), {
                            method: "DELETE",
                            headers: {
                                "Content-Type": "application/json",
                                "Authorization": "Bearer ".concat(this.secretKey)
    ...
    FastLogsRepository.prototype.getUserPersonalData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(this.API_URL, "/audit"), {
                            method: "GET",
                            headers: {
                                "Content-Type": "application/json",
                                "Authorization": "Bearer ".concat(this.secretKey)
    ...
    return FastLogsRepository;
}());
exports.FastLogsRepository = FastLogsRepository;
